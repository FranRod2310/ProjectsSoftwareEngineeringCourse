...
In this sample of the analysis table, we can see the methods that are made up of more than 200 lines of code _(NCLOC - Non-comment count lines of code)_.
...
In such methods, code can easily get confusing and hard do debug. Most if not all of these overly long methods can and should be re-written into multiple **smaller** complimentary methods.
