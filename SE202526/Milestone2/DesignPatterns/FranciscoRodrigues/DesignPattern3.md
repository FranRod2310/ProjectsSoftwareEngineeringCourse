...
![ClassDiagram_3](https://github.com/user-attachments/assets/1725a1ad-e908-4b66-a159-cbbcf525d805)



### Rationale

The Singleton Pattern is used to make sure that only one instance of it is used.

In this case the class `core/src/mindustry/core/Version.java` is the **Singleton**, which makes sure there is no more than 1 instance.
By making the functions static without constructor, it makes sure that only one instance is used.

**Benefits**
- All classes see the same instance without modified fields
