...
`...\core\src\mindustry\content\Items`
...
### Class Diagram
![img.png](ClassDiagram3.png)

### Rationale
The Items class follows the Factory Method pattern as it centralizes the creation of all Item instances within the load() method.
Each specific item (copper, lead, coal, etc.) is instantiated and stored as a static variable, providing global access and
consistent initialization across the game. By encapsulating the item creation process in a single location, the class
simplifies the management of game resources and promotes reusability, while keeping the instantiation logic separate from the rest of the system.